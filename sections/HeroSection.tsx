...
import quangtuandev from "../public/quangtuandev-illustration.webp";
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="Quang Tuan character illustration levitating with a Macbook"
              alt="Quang Tuan character illustration"
            />
          </div>
