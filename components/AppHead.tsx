...
const AppHead: React.FC<Props> = ({
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/quangtuandev-blog-og.png`;
  let appOgImageAlt = "Quang Tuan's Blog";
