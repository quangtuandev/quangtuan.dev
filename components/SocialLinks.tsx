...
const socialLinks = [
  {
    id: 1,
    title: "Quang Tuan's Github Profile",
    link: "https://github.com/quangtuandev",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Quang Tuan's LinkedIn Profile",
    link: "https://www.linkedin.com/in/quangtuandev/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: "Check Quang Tuan on Dev.to",
    link: "https://dev.to/quangtuandev",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 4,
    title: "Quang Tuan's Profile on Facebook",
    link: "https://www.facebook.com/quangtuandev",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
