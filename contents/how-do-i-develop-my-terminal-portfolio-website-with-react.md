...
author: Quang Tuan
type: article
coverImage: https://res.cloudinary.com/noezectz/image/upload/v1654754125/quangtuandev/terminal-screenshot_gu3kkc.png
coverImageAlt: Screenshot of Terminal Portfolio Website
title: How Do I Develop My Terminal Portfolio Website with React
description:
  Quang Tuan's React terminal portfolio website. Styled-components is used
...
- Website: [https://terminal.quangtuandev.store/](https://terminal.quangtuandev.store/ "https://terminal.quangtuandev.store/")
- Repo: [https://github.com/quangtuandev/terminal-portfolio](https://github.com/quangtuandev/terminal-portfolio "https://github.com/quangtuandev/terminal-portfolio")
