...
author: Quang Tuan
type: article
coverImage: https://res.cloudinary.com/noezectz/image/upload/v1653050141/quangtuandev/blog_at_cafe_ei1wf4.jpg
...
I've been always thinking about launching my own website with my custom domain name (**quangtuandev.store**) since my college student life. But that never happened until this project. I've done several projects and works about web application development but I didn't make an effort to do this.
...
> You can search this website on google by using keywords like 'Quang Tuan dev'

![searching quangtuandev.store on google](https://res.cloudinary.com/noezectz/image/upload/v1648231400/quangtuandev/quangtuandev-on-google_asflq6.png "quangtuandev.store is indexed")

Moreover, this website will be displayed well when shared to social media due to properly used meta tags.

![quangtuandev.store card layout when shared to Facebook](https://res.cloudinary.com/noezectz/image/upload/v1653106955/quangtuandev/quangtuandev-dev-share-on-facebook_1_zjoehx.png "Card layout when shared to Facebook")
...
![quangtuandev.store Lighthouse score](https://user-images.githubusercontent.com/53733092/159957822-7082e459-11e9-4616-8f1e-49d0881f7cbb.png "quangtuandev.store Lighthouse score")
...
![animations at quangtuandev.store](https://res.cloudinary.com/noezectz/image/upload/v1653108324/quangtuandev/ezgif.com-gif-maker_2_hehtlm.gif "quangtuandev.store website")
...
- Website: [https://quangtuandev.store/](https://quangtuandev.store/ "https://quangtuandev.store/")
- Blog: [https://quangtuandev.store/blog](https://quangtuandev.store/blog "https://quangtuandev.store/blog")
- Repo: [https://github.com/quangtuandev/my-portfolio](https://github.com/quangtuandev/my-portfolio "https://github.com/quangtuandev/my-portfolio")
