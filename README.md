# Quang Tuan Portfolio & Blog

![quangtuandev-portfolio-and-blog](https://user-images.githubusercontent.com/53733092/169645862-d1dda9cb-482f-4428-a63c-8eaf6910ab35.png)
![ts](https://badgen.net/badge/Built%20With/TypeScript/blue) ![vercel](https://img.shields.io/github/deployments/quangtuandev/my-portfolio/production?label=vercel&logo=vercel&logoColor=white)
...
<p align="center">
  <a href="https://pagespeed.web.dev/report?url=https%3A%2F%2Fquangtuandev.store%2F&form_factor=desktop">
    <img width="710" alt="Quang Tuan Portfolio Website Lighthouse Score" src="public/lighthouse-result.svg">
  <a>
</p>
...
```bash
git clone https://github.com/quangtuandev/quangtuandev.store.git
```

Go to the project directory

```bash
cd quangtuandev.store
```
...
- [@quangtuandev](https://quangtuandev.store)
